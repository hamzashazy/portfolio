      ...
      <ul className="space-y-10 pl-12">
        {siteConfig.sections.experiences.map((exp, idx) => (
          <li key={idx} className="relative group">
            <span className="absolute -left-7 top-1.5 w-6 h-6 rounded-full bg-gradient-to-br from-pink-400 to-indigo-400 flex items-center justify-center shadow-lg border-4 border-background">
              <FaBriefcase className="text-white text-lg" />
            </span>
            <div className="bg-black/30 backdrop-blur-lg rounded-2xl border border-white/10 p-6 transition-transform duration-300 group-hover:scale-[1.02]">
=======
